...
import { ScrollProgressBar, scrollToSection } from "../utils/scrollToSection";
...
<section id='heroId' className="bg-primary-bg text-white">
   ...
   <div className="flex-grow flex items-center">
     ...
     <div>
     <button onClick={() => scrollToSection('contentId')}>
...
const Content = () => {
    return(
        ...
        <section id='contentId' className="mb-16 px-small px-large ">
            <div>
              <ScrollProgressBar/>
                <ServiceShowcase/>
                <CTA/>
...
const ServiceItem = ({ icon, title, content, index }) => (
  <div className={`flex flex-row p-3 rounded-[20px] ${index !== features.length - 1 ? "mb-6" : "mb-0"} feature-card  hover:shadow-md duration-300`}>
...
const Partners = () =>(
  <section>
    ...
    <div className="flex justify-center md:mt-16 mt-8 space-x-2 lg:space-x-96">
